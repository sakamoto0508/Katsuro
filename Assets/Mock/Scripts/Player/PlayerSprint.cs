...
public class PlayerSprint
{
    ...
    public PlayerSprint(PlayerStateConfig playerStateConfig)
    {
        _maxSkillGauge = Mathf.Max(1f, playerStateConfig.MaxSkillGauge);
        _dashGaugeCostPerSecond = Mathf.Max(0.01f, playerStateConfig.DashGaugeCostPerSecond);
        _skillGaugeRecoveryPerSecond = Mathf.Max(0f, playerStateConfig.SkillGaugeRecoveryPerSecond);
    ...
    public float DashGauge => _currentSkillGauge;
